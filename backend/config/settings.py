...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-imporvia-dev-secret-key-12345')
...
CSRF_TRUSTED_ORIGINS = [o.strip() for o in os.environ.get('CSRF_TRUSTED_ORIGINS', 'http://localhost:3000').split(',') if o.strip()]
...
LANGUAGE_CODE = 'fr-fr'
TIME_ZONE = 'Africa/Douala' # Cameroun timezone
USE_I18N = True
USE_TZ = True
